<template>
  <el-form-item
    :class="'form-item-' + item.component"
    v-bind="item.$formItem"
    :label="showLabel ? item.$formItem.label : ''"
  >
    <slot-render v-if="item.label && showLabel && item.label.constructor !== String" :render="item.label" slot="label">
    </slot-render>
